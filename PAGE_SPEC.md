...
`/achievements` 已接入免费领养、取名/改名、三种食物兑换与喂养、五阶段成长相册、学习积分概览和收支记录；原教材成长能量及里程碑单独保留。全站页头显示可用积分并链接宠物小屋；该页与思维、阅读一样不强制教材配置。取当前学习档案，事务保存成功才展示兑换或喂养成功。完整规则、数据所有权与失败边界见 [学习积分与宠物成长](PET_GROWTH.md)。

第二阶段新增三位伙伴收藏及独立经验、四种可兑换家园装饰、切换伙伴查看成长相册；家长报告增加按时间与来源筛选的积分统计。宠物小屋底部折叠区提供家长注册/登录、备份列表、预览和恢复。该入口明确只备份宠物账本，遇到不兼容历史停止覆盖，不宣称全站自动同步。启动与部署见 [宠物后端](PET_BACKEND.md)。
