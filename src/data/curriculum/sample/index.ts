/**
 * Explicit SAMPLE namespace. The legacy sibling directories remain the single
 * source of the existing development fixtures; this file only names that
 * namespace and does not duplicate the records.
 */
export { curriculumData, curriculumIndexes } from '../index'
...
export { sampleQuestions } from '../questions'
